...
public class HelloControllerIntegrationTest {
    ...
    @Test
    void helloAlwiya() {
        ResponseEntity<String> responseEntity = restTemplate.getForEntity("http://localhost:" + port + "/hello?name=Alwiya", String.class);
        String response = responseEntity.getBody();

        Assertions.assertNotNull(response);
        Assertions.assertEquals("Hello Alwiya", response.trim());
    }
